# Type-Game
Type Game is a word spell bee game in which you have to write the exact same word with Uppercase and Lowercase alphabets which is randomly generated by the game scripts. It has 3 difficulty levels : Easy, Medium, Hard , you can choose the mode before you start typing. There is a Score board that turns +1 if you type correct within the time limit exceeds. Oncee you exceeds the time limit, then its GAME OVER!!
<br>
